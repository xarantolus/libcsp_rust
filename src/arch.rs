...
macro_rules! export_arch {
    ($impl_type:ty, $instance:expr) => {
        ...
        #[no_mangle] pub unsafe extern "C" fn csp_get_ms_isr() -> u32 { <$impl_type as $crate::CspArch>::get_ms(&$instance) }
        ...
        #[no_mangle] pub unsafe extern "C" fn csp_mutex_unlock(mutex: *mut *mut ::core::ffi::c_void, timeout: u32) -> i32 {
            // Safety: `mutex` is a valid pointer.
        ...
        #[no_mangle] pub unsafe extern "C" fn csp_sys_reboot() { <$impl_type as $crate::CspArch>::reboot(&$instance) }
        #[no_mangle] pub unsafe extern "C" fn csp_sys_shutdown() { <$impl_type as $crate::CspArch>::shutdown(&$instance) }
